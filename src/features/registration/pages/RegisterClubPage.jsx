  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <button onClick={() => navigate(ROUTES.REGISTER)} className="flex items-center text-gray-600 hover:text-gray-900 mb-4">
        ...
        <div className="mb-6">
          <h1 className="text-2xl font-bold text-gray-900">Registro para Club</h1>
          <p className="text-sm text-gray-600">Completa los datos personales del deportista.</p>
        </div>
