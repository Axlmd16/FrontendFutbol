/**
 * ==============================================
 * Página de Editar Usuario - Kallpa UNL
 * ==============================================
 * 
...
/**
 * EditUserPage - Página de edición de usuario
 * 
 * @returns {JSX.Element} Página de editar usuario
 */
const EditUserPage = () => {
  // ==============================================
  // ESTADO
      ...
      <div className="min-h-screen bg-gray-50 py-8 px-4 sm:px-6 lg:px-8">
        <div className="max-w-3xl mx-auto text-center">
          <div className="bg-white rounded-lg shadow-lg p-8">
            ...
            <h2 className="mt-4 text-xl font-bold text-gray-900">Usuario no encontrado</h2>
      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="mt-1 text-sm text-gray-500">
            Modifica los datos del usuario <strong>{user?.name}</strong>
          </p>
        </div>
